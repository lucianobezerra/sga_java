...
public class FrameUsuario extends javax.swing.JDialog {
  ...
  private void initComponents() {
    ...
    if (tableUsuarios.getColumnModel().getColumnCount() > 0) {
      ...
      tableUsuarios.getColumnModel().getColumn(2).setPreferredWidth(200);
  ...
  private void formataGrid(JTable tableUsuarios) {
    Funcoes.formatFontHeader(tableUsuarios, new Font("Arial", Font.PLAIN, 12));
    Funcoes.formatFontGrid(tableUsuarios, new Font("Arial", Font.PLAIN, 12));
    Funcoes.alinhaColunas(tableUsuarios, 0, SwingConstants.CENTER);
    Funcoes.sizeColumn(tableUsuarios, 0, 40);
    Funcoes.sizeColumn(tableUsuarios, 1, 160);
